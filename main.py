...
def Fitting(gp, j):
    ...
    try:
        ...
        print("cri_value{}: {} at {}".format(j, round(cri_ampl, 3), round(cri_time, 3)))
...
def Figure(df, fit_off, fit_on, ymin, ymax):
    ...
    plt.plot(df["Time"], df["Ampl"], c="grey", lw=0.5)
    ...
    plt.title(title, fontsize=15, fontweight="bold", y=1, pad=10) 
